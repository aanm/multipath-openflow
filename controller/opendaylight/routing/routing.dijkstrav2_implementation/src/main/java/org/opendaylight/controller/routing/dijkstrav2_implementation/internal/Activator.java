...
public class Activator extends ComponentActivatorAbstractBase {
     ...
     * instantiated in order to get an fully working implementation Object
     */
    @Override
     ...
     * required.
     *
     * @param c dependency manager Component object, used for configuring the
     * dependencies exported and imported
     * @param imp Implementation class that is being configured, needed as long
     * as the same routine can configure multiple implementations
     * @param containerName The containerName being configured, this allow also
     * optional per-container different behavior if needed, usually should not
     * be the case though.
     */
    @Override
    public void configureInstance(final Component c, final Object imp, final String containerName) {
        if (imp.equals(DijkstraImplementation.class)) {
            ...
            c.setInterface(new String[]{ITopologyManagerClusterWideAware.class.getName(), IDijkstraInterface.class.getName()},
                           props);
