...
public class Activator extends AbstractBindingAwareConsumer {
    ...
    public void onSessionInitialized(ConsumerContext session) {
        ...
        IfIptoHost i = (IfIptoHost) ServiceHelper.getGlobalInstance(IfIptoHost.class, this);
        m.setHostFinder(i);
        IDijkstraInterface iDijkstra = (IDijkstraInterface) ServiceHelper.getGlobalInstance(IDijkstraInterface.class, this);
