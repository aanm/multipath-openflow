...
public final class ActionConvertor {
    ...
    private static Action SalToOFExperimenter(
            org.opendaylight.yang.gen.v1.urn.opendaylight.action.types.rev131112.action.Action action,
            ActionBuilder actionBuilder) {
        org.opendaylight.yang.gen.v1.urn.opendaylight.openflow.augments.rev131002.ExperimenterActionBuilder experimenterActionBuilder = new org.opendaylight.yang.gen.v1.urn.opendaylight.openflow.augments.rev131002.ExperimenterActionBuilder();
        ExperimenterActionCase experimenterActionCase = (ExperimenterActionCase) action;
        org.opendaylight.yang.gen.v1.urn.opendaylight.action.types.rev131112.action.action.experimenter.action._case.ExperimenterAction experimenterAction = experimenterActionCase.getExperimenterAction();
        experimenterActionBuilder.setExperimenter(experimenterAction.getExperimenter());
        experimenterActionBuilder.setData(experimenterAction.getData());
        actionBuilder.setType(Experimenter.class);
        actionBuilder
                .addAugmentation(
                        ExperimenterAction.class, experimenterActionBuilder.build());
        return actionBuilder.build();
    }
    ...
    /**
     * Method converts OF Experimenter action object to SAL Output action
     * object.
     *
     * @param action
     * org.opendaylight.yang.gen.v1.urn.opendaylight.openflow.common.
     * action.rev130731.actions.actions.list.Action
     * @return ExperimenterAction
     */
    public static ExperimenterActionCase ofToSALExperimenter(Action action) {

        ExperimenterActionBuilder experimenterAction = new ExperimenterActionBuilder();
        ExperimenterAction experimenter = action.getAugmentation(ExperimenterAction.class);
        experimenterAction.setData(experimenter.getData());
        experimenterAction.setExperimenter(experimenter.getExperimenter());

        return new ExperimenterActionCaseBuilder().setExperimenterAction(experimenterAction.build()).build();
    }
}
